...
#property indicator_color1 DodgerBlue, Red, Yellow
...
double BullPrevVal[3]= {false, false, false}; 
//+------------------------------------------------------------------+
...
//--- indicator buffers mapping
  ...
  SetIndexBuffer(5,BullPrevVal,INDICATOR_DATA);
//---
